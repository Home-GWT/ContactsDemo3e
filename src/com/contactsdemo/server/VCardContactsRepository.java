...
package com.contactsdemo.server;
...
public class VCardContactsRepository implements IContactsRepository {
    ...
    /*
     * Для Windows-системы .......... String path = getClass().getResource("").getPath();
     * Для Linux-системы ............ String path = "/"+getClass().getResource("").getPath();
     */
	private String getVCardsDir() {
        String path = "/"+getClass().getResource("").getPath(); //String path = getClass().getResource("").getPath();
